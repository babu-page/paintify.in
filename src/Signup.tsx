...
export const Signup = () => {
    ...
    // 3D Tilt Effect - Simplified for stability
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (success) {
            ...
            setError('REGISTRATION FAILED: IDENTITY ALREADY EXISTS OR SYSTEM ERROR');
        }
    };
            ...
            >
                <div className="text-center mb-12" style={{ transform: "translateZ(60px)" }}>
                    <div className="bg-gradient-to-br from-indigo-500 to-indigo-700 w-24 h-24 rounded-[2.5rem] flex items-center justify-center mx-auto mb-10 shadow-2xl shadow-indigo-500/30 transform -rotate-6 border border-white/20 relative group">
                        <UserPlus size={40} className="text-white" strokeWidth={2.5} />
                    ...
                    <div className="flex flex-col items-center">
                        <h2 className="text-5xl font-black text-white tracking-tighter mb-4">REGISTRY</h2>
                        <div className="flex items-center gap-3">
                            <span className="w-8 h-px bg-indigo-500/30"></span>
                            <p className="text-slate-500 font-black uppercase tracking-[0.5em] text-[10px]">Unit Initialization</p>
                            <span className="w-8 h-px bg-indigo-500/30"></span>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-16 text-center" style={{ transform: "translateZ(20px)" }}>
                    <div className="p-6 bg-white/5 rounded-3xl border border-white/5">
                        ...
                        <Link to="/login" className="inline-block mt-4 text-white hover:text-indigo-400 transition-colors uppercase tracking-[0.4em] text-[10px] font-black border-b border-white/10 pb-1">
                            Access Portal
                        </Link>
                    </div>
                </div>
                ...
                <div className="mt-12 flex justify-center gap-4">
                    <div className="flex items-center gap-2 px-4 py-2 bg-slate-950 rounded-full border border-white/5">
                        ...
                        <span className="text-[8px] font-black text-slate-500 uppercase tracking-widest">Encrypted Initialization</span>
                    </div>
                </div>
            </motion.div>
        </div>
